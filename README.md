...
#### Latest release v2.0.9-beta
##### [Click here to see the patch notes](https://github.com/accessibilitysoftwarehub/FaceSwitch2/wiki/Whats-new)
##### [Click here to download the latest release](https://github.com/accessibilitysoftwarehub/FaceSwitch2/releases/tag/v2.0.9-beta)
...
# Installation Manual for Face Switch 2.0.9-beta

# 1. Download
[Click to download](https://github.com/accessibilitysoftwarehub/FaceSwitch2/releases/download/v2.0.9-beta/FaceSwitchSetup.exe)
